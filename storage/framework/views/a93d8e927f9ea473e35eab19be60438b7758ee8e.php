	...
	<head>
		<meta charset="UTF-8">
		<title><?php echo e($goods->title); ?>_<?php echo e(config("web.title")); ?></title>
		<meta name="keywords" content="<?php echo e($goods->title); ?>" />
		<meta name="description" content="<?php echo e($goods->info); ?>" />
	...
	<body>
		...
		<div class="container centers">
			<div class="mianbao">
				<a href="/">首页</a> &gt; <a href="#">商品详情</a>&gt; <?php echo e($goods->title); ?>
				...
				<div class="ac-left">  
					...
					<div class="imgs" id="imgSlider">
						...
						<ul class="img-d" id="imgBig">
							<?php $__currentLoopData = $goodsImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<li id="bigim<?php echo e($key); ?>" style="z-index:1;filter: alpha(opacity=100); opacity: 1;"><a href="javascript:;">
						...
						<div class="img-x">
							<ul class="pro_ul" id="imgSmall" style="width: 408px;">
								<?php $__currentLoopData = $goodsImg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li id="im<?php echo e($key); ?>"
								<?php if($key == 0): ?>
								style="filter:alpha(opacity:100);opacity:1;"
								<?php endif; ?>
								>
								<a href="javascript:;">
									<img width="88px" height="88px" src="/Uploads/goods/<?php echo e($img->img); ?>" alt="<?php echo e($goods->title); ?>">
								</a>
							</li>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</ul>
			...
			<div class="ac-right">
				...
				<div class="ar-main">
					<div class="amt clearfix">
						<span >商城价：</span>
						<b>¥<?php echo e(number_format($goods->price)); ?></b>
						<div id="yd">
			...
			<div class="de_info_btn clearfix">
				<div class="de_info_num">
					<label class="i_box">
						<input class="pro_num J_input" type="text" id="goodsNumber" value="1">
...
<div class="mainsss">
	...
	<div class="box-rt">
		...
		<div id="content">
			<!-- 商品详情 -->
			<ul><?php echo $goods->text; ?></ul>
			<!-- 配置信息 -->
			<ul style="display: none;"><?php echo $goods->config; ?></ul>
			<?php if($arr['commentTot']): ?>	                                                          
					...
					<div id="pager_divdiv3" class="ns_discusspager">
						<div class="ns_comment-inner" id="sppl_box">
							<dl id="sppl_title"> 
								...
								<dd class="sppl_total active" data-level="0">全部评价(<span><?php echo e($arr['commentTot']); ?></span>)
								</dd>  
								<dd class="sppl_good" data-level="3">好评(<span><?php echo e($arr['goodTot']); ?></span>)</dd> 
								<dd class="sppl_medium" data-level="2">中评(<span><?php echo e($arr['midTot']); ?></span>)</dd>  
								<dd class="sppl_total" data-level="1">差评(<span><?php echo e($arr['badTot']); ?></span>)
								</dd> 
							</dl>
							<dl id="sppl_list" class="clearfix">
								<?php $__currentLoopData = $comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discuss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<dd>
									<div class="sppl_top">  
										<span style="color: red;"><?php echo e(str_repeat("★", $discuss->start)); ?><?php echo e(str_repeat("☆", 5 - $discuss->start)); ?></span>   
										<span class="sppl_username"><?php echo e($discuss->name); ?></span>   
										<span class="sppl_time"><?php echo e(date("Y-m-d H:i:s",$discuss->time)); ?></span>  
									</div>  
									<div class="sppl_user_box">
										<p><a class="clickpl" uuid="9ffce34a-deda-483c-8754-833b29421f76" href="javascript:void(0);"><?php echo e($discuss->text); ?>  </a>
										</p> 
									</div>      
								</dd>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
