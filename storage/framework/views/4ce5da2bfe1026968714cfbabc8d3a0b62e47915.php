		...
		<table class="table-bordered table table-hover">
			...
			<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					...
					<?php if($tot>=2): ?>
						<td><a href="javascript:;" title="">添加子类</a></td>
					<?php else: ?>
						<td><a href="/admin/types/create?pid=<?php echo e($value->id); ?>&path=<?php echo e($value->path); ?><?php echo e($value->id); ?>," title="">添加子类</a></td>
					<?php endif; ?>
					<td>
						<?php if($value->is_lou): ?>
							<span class="btn btn-primary">是</span>
						<?php else: ?>
							<span class="btn btn-success">否</span>
						<?php endif; ?>
					</td>
					<td><a href="/admin/types/<?php echo e($value->id); ?>/edit" class="glyphicon glyphicon-pencil"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="del(<?php echo e($value->id); ?>)" class="glyphicon glyphicon-trash"></a></td>
				</tr>	
