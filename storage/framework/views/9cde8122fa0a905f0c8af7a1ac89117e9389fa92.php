          ...
          <li>
            <div class="left-menu">
              ...
              <div class="left-xiang">
                ...
                <div class="left-zong">
                  <!-- 分类展示-->
                  <?php $__currentLoopData = $one->son; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $two): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="left-zi">
                    <p><a href="/types/<?php echo e($two->id); ?>" ><?php echo e($two->name); ?></a></p>
                    <ul class="clearfix">
                      <?php $__currentLoopData = $two->son; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $three): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="left-tu">
                  ...
                  <a href=""><img class="classification_img" title="<?php echo e($rightAds->title); ?>" src="/Uploads/ads/<?php echo e($rightAds->img); ?>"></a>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
              </div>
    ...
    <div class="center">
      <ul class='imgs'>
        <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($key==0): ?>
            <li class='active'><a href="<?php echo e($value->href); ?>" target="_blank"><img src="/Uploads/lun/<?php echo e($value->img); ?>" alt="<?php echo e($value->title); ?>"></a></li>
          <?php else: ?>
            <li><a href="<?php echo e($value->href); ?>" target="_blank"><img src="/Uploads/lun/<?php echo e($value->img); ?>" alt="<?php echo e($value->title); ?>"></a></li>
          <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
      <ul class='nums'>
     ...
     <div class="bao"> 
      ...
      <div class="boo">
        <ul class="bo-1"> 
          ...
          <?php if($key>1): ?>
          <li style="width: 252px; height: 159px;"><a target="_blank" href="<?php echo e($value->href); ?>"><img src="/Uploads/ads/<?php echo e($value->img); ?>" alt="<?php echo e($value->title); ?>"></a>
            <?php else: ?>
            <li><a target="_blank" href="<?php echo e($value->href); ?>"><img src="/Uploads/ads/<?php echo e($value->img); ?>" alt="<?php echo e($value->title); ?>"></a>
              <?php endif; ?>
            </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </ul>
          ...
          <ul>
            ...
            <li style="width: 198px; height: 297px;">
              <a target="_blank" href="/goods/<?php echo e($good->id); ?>"> 
                <img width="198px" height="230px" title="<?php echo e($good->title); ?>" src="/Uploads/goods/<?php echo e($good->img); ?>">
              </a>
              <p class="star_name">
                <a target="_blank" title="<?php echo e($good->title); ?>" href="/goods/<?php echo e($good->id); ?>"><?php echo e($good->title); ?></a>
              </p>
              <p class="star_ad">
                <a target="_blank" href="/goods/<?php echo e($good->id); ?>"><?php echo e($good->info); ?></a>
              </p>
              <p class="star_price"><a target="_blank" href="/goods/<?php echo e($good->id); ?>"><?php echo e(number_format($good->price)); ?>元</a></p>
            </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          <div class='clear'></div>
        </ul>
    ...
    <div class="ceng"> 
      <div class='container lou'>
        ...
        <?php
          $louNum = 0;
        ?>
        <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($floor->is_lou): ?>
            <?php
              $louNum++;
            ?>
            <div class="lenovo">
             <div class="title"> 
               <h3><span><?php echo e($louNum); ?>F</span><em><?php echo e($floor->name); ?></em></h3>
               <div class="jieshao">
                <?php $__currentLoopData = $floor->son; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $son): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <a target="_blank" href="" title="<?php echo e($son->name); ?>"><?php echo e($son->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="rong">
             <div class="zuo">
                <a target="_blank" href="" title="<?php echo e($floor->leftAds->title); ?>"> <img width="240" height="535" src="/Uploads/ads/<?php echo e($floor->leftAds->img); ?>"></a>
             </div>
             <div class="you">
              <?php $__currentLoopData = $floor->goods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $fgoods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="you<?php echo e(++$key); ?> good">
                  <a target="_blank" href="/goods/<?php echo e($fgoods->id); ?>" title="<?php echo e($fgoods->title); ?>"> <img width="164" height="164" src="/Uploads/goods/<?php echo e($fgoods->img); ?>" ></a>
                 <a class="good-jie"target="_blank" href="/goods/<?php echo e($fgoods->id); ?>"><?php echo e($fgoods->title); ?></a>
                 <a class="good-jie1"target="_blank" href="/goods/<?php echo e($fgoods->id); ?>" title="<?php echo e($fgoods->title); ?>"><?php echo e($fgoods->info); ?>

                 </a>
                 <a class="money"  target="_blank" href="/goods/<?php echo e($fgoods->id); ?>"  title="<?php echo e($fgoods->title); ?>"><?php echo e(number_format($fgoods->price)); ?>元
                 </a>
