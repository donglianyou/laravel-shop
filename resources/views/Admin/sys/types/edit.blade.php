			...
			<div class="col-md-10">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="/admin/types" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> 广告页面</a>
						<a href="/admin/types/create" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加广告</a>
					</div>
					<div class="panel-body">
						<form action="/admin/types" method="post">
							...
							<div class="form-group">
								<label for="">广告名</label>
								<input type="text" name="name" class="form-control" id="" placeholder="请输入广告名">
							</div>
