...
<body>
  ...
  <div class="container carouse">
      ...
      <li>
       <div class="left-menu">
         <a href="http://www.lenovo.com.cn/lenovoindex.html">Lenovo 电脑
         ...
         <!-- 详细内容 -->
          <div class="left-xiang">
            ...
            <div class="left-tu">
              <a href="">
                <img class="classification_img" src="/style/home/img/68.jpg">
              </a>
              <a href="">
                <img class="classification_img" src="/style/home/img/69.jpg">
              </a>
            </div>
          </div>
        </div>
       ...
       <li>
      <div class="left-menu">
      <a href="" target="_blank" class="list_nm" style="height:10.56px;line-height:10.56px" >ThinkPad 电脑
        <span class="list_usepng list_icona"></span>
      </a>
            ...
            <div class="left-zi">
              ...
              <ul class="clearfix">
                <li>
                  ...
                  <a href="" target="_blank" >ThinkPad专属选件</a>
              </li>
              </ul>
            </div>
            <div class="left-zi">
      ...
      <li>
      <div class="left-menu">
      <a href="http://www.lenovo.com.cn/pad.html" class="list_nm" style="height:10.56px;line-height:10.56px" latag="latag_pc_common_navcategory_3_平板电脑">平板电脑
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
            <div class="left-zi">
                <p>
                  <a href="" >MIIX系列二合一笔记本</a>
                </p>
                <ul class="clearfix">
                  <li>
                    <a href="" >MIIX 4 Pro系列</a>
                  </li>
                  <li>
                    <a href="" >MIIX 5 系列</a>
                  </li>
          ...
          <div class="left-tu">
            <a href="">
              <img class="classification_img" src="/style/home/img/03cef7f6-9ec4-4d37-9acc-ab550d5d3f8f.jpg">
            </a>
            <a href="/48206.html">
              <img class="classification_img" src="/style/home/img/4c2a32b8-534c-434b-8afa-85706903d7bc.jpg">
      ...
      <li>
      <div class="left-menu">
      <a href="" target="_blank" class="list_nm" style="height:10.56px;line-height:10.56px" >手机
      </a>
      </div>
      </li>
      <li>
      <div class="left-menu">
      <a href="http://www.lenovo.com.cn/lenovo_channel_dongde.html" target="_blank" class="list_nm" style="height:10.56px;line-height:10.56px" >通信卡
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
            <div class="left-zi">
                <p>
                   <a href="" target="_blank" >170/171</a>
                </p>
                <ul class="clearfix">
                  <li>
                    <a href="" target="_blank" >懂陪伴</a>
                  </li>
                  <li>
                    <a href="" target="_blank" >糖豆儿</a>
                  </li>
                  <li>
                    <a href="" target="_blank">大白话</a>
                  </li>
                </ul>
            </div>
            <div class="left-zi">
                <p>
                   <a href="" target="_blank">国际卡</a>
                </p>
                <ul class="clearfix">
                  <li>
                  <a href="" target="_blank" >港澳卡</a>
                  </li>
                  <li>
                  <a href="" target="_blank">日本卡</a>
                  </li>
                  <li>
                  <a href="" target="_blank" l>欧洲卡</a>
                  </li>
                  <li>
                  <a href="" target="_blank" >美国卡</a>
                  </li>
                  <li><a href="" target="_blank" >泰国卡</a>
                  </li>
                  <li><a href="" target="_blank" >新加坡卡</a>
                  </li>
                </ul>
            </div>
            <div class="left-zi">
          ...
          <div class="left-tu">
            <a href="">
              <img class="classification_img" src="/style/home/img/4a50384d-d437-4c19-8778-ae1cb2324c40.jpg">
            </a>
            <a href="">
              <img class="classification_img" src="/style/home/img/dac2a37c-1e84-46a7-8430-df66cbb2228e.jpg">
            </a>
          </div>
        </div>
      </div>
      ...
      <li>
      <div class="left-menu">
      <a href="" class="list_nm" style="height:10.56px;line-height:10.56px" >打印机
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
          ...
          <div class="left-tu">
            <a href="">
              <img class="classification_img" src="/style/home/img/1032c43b-5f00-42a8-b5e9-f18fd19827d4.jpg">
            </a>
            <a href="">
              
              <img class="classification_img" src="/style/home/img/73d7a590-4491-4a10-826a-0f78eb42f62d.jpg">
            </a>
          </div>
        </div>
      </div>
      ...
      <li>
      <div class="left-menu">
      <a href="" class="list_nm" style="height:10.56px;line-height:10.56px" >智能数码
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
            <div class="left-zi">
              ...
              <ul class="clearfix">
                ...
                <li>
                 <a href="" >联想（ThinkVision)显示器</a></li>
                <li>
                  <a href="" >电脑包</a>
                </li>
                <li>
          ...
          <div class="left-tu">
            <a href="">
              <img class="classification_img" src="/style/home/img/7233cbd2-a72f-472b-85d5-e6aca7931aa1.jpg">
            </a>
            <a href="">
              <img class="classification_img" src="/style/home/img/CmBZD1ZfxD-AUvv3AABFDvFeCr4658.jpg">
            </a>
          </div>
        </div>
      </div>
      ...
      <li>
      <div class="left-menu">
      <a href="" class="list_nm" style="height:10.56px;line-height:10.56px" >电脑增值服务
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
            ...
            <div class="left-zi">
                ...
                <ul class="clearfix">
                  <li>
                    <a href="" target="_blank" >电脑加速</a>
                  </li>
                  <li>
                    <a href="" target="_blank" >数据恢复</a>
                  </li>
                  <li>
                    <a href="" target="_blank">驱动安装</a>
                  </li>
                  <li>
                    <a href="" target="_blank">新机开荒</a>
                  </li>
                  <li>
                   <a href="" target="_blank" >专家上门</a>
                  </li>
                </ul>
            </div>
            <div class="left-zi">
          ...
          <div class="left-tu">
          <a href="">
            <img class="classification_img" src="/style/home/img/CmBZD1Zf7EWAI0yrAABOZ3OvYzY157.jpg">
          </a>
          <a href="">
            <img class="classification_img" src="/style/home/img/CmBZEFZf6WWAQiskAABMaIeji_A283.jpg">
          </a>
          </div>
        </div>
      </div>
      ...
      <div class="left-menu">
      <a href="" target="_blank" class="list_nm" style="height:10.56px;line-height:10.56px" >商用产品
        <span class="list_usepng list_icona"></span>
      </a>
        <div class="left-xiang" style="display: none;">
          <div class="left-zong">
            <div class="left-zi">
          <p>
             <a href="" target="_blank" lX>商用桌面产品</a>
          </p>
          <ul class="clearfix">
            <li>
              <a href="" target="_blank" >昭阳笔记本</a>
            </li>
            <li>
             <a href="" target="_blank">ThinkCenter台式机</a>
            </li>
            <li>
              <a href="" target="_blank">ThinkStation工作站</a>
            </li>
            <li>
             <a href="" target="_blank">Thinkpad</a>
            </li>
            <li>
            
             <a href="" target="_blank" >移动互联</a>
            </li>
          </ul>
            </div>
            <div class="left-zi">
              <p>
              <a href="" target="_blank" >企业级产品</a>
              </p>
              <ul class="clearfix">
                <li>
                  <a href="" target="_blank" >服务器System x</a>
                </li>
                <li>
                  <a href="" target="_blank" >服务器ThinkServer</a>
                </li>
                <li>
                  <a href="" target="_blank" >存储产品</a>
                </li>
                <li>
                 <a href="" target="_blank"  >网络产品</a>
                </li>
                <li>
          ...
          <div class="left-tu">
            <a href="">
             <img class="classification_img" src="/style/home/img/23c530d0-35b0-427f-bdb3-912da9e4e1c0.jpg">
            </a>
            <a href="thinkstation/index.html">
              <img class="classification_img" src="/style/home/img/CmBZD1aXD_CATboZAABJzR3fAbs958.jpg">
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="center">
      <ul class='imgs'>
        <li class='active'><img src="/style/home/img/62.jpg" alt=""></li>
        <li><img src="/style/home/img/63.jpg" alt=""></li>
        <li><img src="/style/home/img/64.jpg" alt=""></li>
        <li><img src="/style/home/img/65.jpg" alt=""></li>
        <li><img src="/style/home/img/66.jpg" alt=""></li>
        <li><img src="/style/home/img/67.jpg" alt=""></li>
        <ul class='nums'>
          <li class="active"></li>
          <li></li>
          <li></li>
    ...
    <div class="boo">
      <ul class="bo-1"> 
          <li>
            ...
            <img src="/style/home/img/82.jpg">
          </a>
          </li>
          <li>
           <a target="_blank" href="">
           <img src="/style/home/img/81.jpg">
          </a>
          </li> 
          <li  style="width: 252px; height: 159px;">
            <a target="_blank" href="">
            <img src="/style/home/img/80.jpg">
          </a>
          </li>
          <li style="width: 252px; height: 159px;">
            <a target="_blank" href="">
            <img src="/style/home/img/79.jpg">
            </a>
          </li> 
          <li  style="width: 252px; height: 159px;">
            <a target="_blank" href="">
            <img src="/style/home/img/120.jpg">
            </a>
          </li>
          <li  style="width: 252px; height: 159px;">
            <a target="_blank" href="">
        ...
        <li latag="" style="width: 252px; height: 159px;">
          <a target="_blank" href="">
            <img src="/style/home/img/80.jpg">
          </a>
        </li>
        ...
        <li  style="width: 252px; height: 159px;">
          <a target="_blank" href="">
            <img src="/style/home/img/130.jpg">
          </a>
        </li>
        <li  style="width: 252px; height: 159px;">
          <a target="_blank" href="">
        ...
        <listyle="width: 252px; height: 159px;">
          <a target="_blank" href=";cid=sqgc2057">
          <img src="/style/home/img/130.jpg">
          </a>
        </li>
        <li style="width: 252px; height: 159px;">
        ...
        <li style="width: 252px; height: 159px;">
          <a target="_blank" href=""><img src="/style/home/img/82.jpg">
        </a>
        </li>
        <li style="width: 252px; height: 159px;">
           <a target="_blank" href="">
