                ...
                <tr class=" active" gcode="52770" stock="18">
                    ...
                    <td width="152" text-align:center>
                        <label class="i_box clearfix">
                            <input class="pro_less J_minus" ids="{{$car['goodsInfo']->id}}" type="button" value="-">
                            <input class="pro_num J_input" type="text" value="{{$car['num']}}" style="ime-mode: disabled;" val="{{$car['num']}}">
                            <input class="pro_add J_add" ids="{{$car['goodsInfo']->id}}" type="button" value="+">
                        </label>
                    </td>
                    @php
    ...
    <div class="bc_num clearfix">
        ...
        <ul class="bc_num_fr">
         <!--    <li style="margin-top:0;">商品总价：7499.00 元</li>
            <li>优惠节省：500.00 元</li> -->
            <li>合计：<span class="bc_red" id="totalmoneyf">{{$tot}} 元</span></li>
        </ul>
    </div>
